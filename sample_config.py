...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or 
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/NEIMAN-AI/NEIMAMBOT"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://te.legra.ph/file/1d874d72f28b26b228242.jpg"
    )
    ...
    # Google Drive plugin https://graph.org/G-Drive-guide-for-bot-01-01
    ...
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/NEIMAN-AI/Plugins-XyZ"
    else:
        EXTERNAL_REPO = None
